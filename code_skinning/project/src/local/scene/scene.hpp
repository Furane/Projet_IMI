...
private:
    ...
    /** Mesh of the skinned scotty for OpenGL drawing */
    cpe::mesh_opengl mesh_scotty_opengl;
    /** Texture of the scotty */
    GLuint texture_scotty;

    /** Skeleton of the bind pose for Scotty */
    cpe::skeleton_geometry sk_scotty_bind_pose;
    /** Parent id for the skeleton of Scotty */
    cpe::skeleton_parent_id sk_scotty_parent_id;
    /** Animation of the skeleton for Scotty */
    cpe::skeleton_animation sk_scotty_animation;

    /** Kinect skeleton */
    cpe::skeleton_geometry sk_kinect;
    ...
    /** NITE variables used for load_scene */
